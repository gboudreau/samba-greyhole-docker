...
RUN apk --no-cache add \
    ...
    php7-cli php7-pdo_mysql php7-intl php7-mbstring php7-intl php7-mysqlnd rsync lsof sysstat findutils
...
VOLUME ["/var/cache/samba", "/var/lib/samba", "/var/log/samba", "/run/samba", "/config-greyhole"]
